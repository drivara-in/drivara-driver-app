...
extension _PeriodX on _Period {
  ...
  String get shortLabel {
    switch (this) {
      case _Period.d7: return '7D';
      case _Period.d30: return '30D';
      case _Period.d90: return '90D';
...
class _EarningsPageState extends State<EarningsPage> {
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: CustomScrollView(
          ...
          slivers: [
            SliverToBoxAdapter(child: _hero(context, avgPerTrip)),
            SliverToBoxAdapter(child: _periodChips(context)),
            ...
            if (_loading)
              ...
              SliverFillRemaining(
                ...
                child: _emptyState(
                  ...
                  'No completed trips in ${_period.label.toLowerCase()}',
                ),
              )
            else ...[
              SliverToBoxAdapter(child: _sectionHeader(context, 'TRIPS', _jobs.length)),
              SliverPadding(
  ...
  Widget _hero(BuildContext context, num avgPerTrip) {
    return Padding(
...
class _TripCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final role = (job['role']?.toString() ?? 'primary').toUpperCase();
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                              fontSize: 9,
                              fontWeight: FontWeight.w800,
                              color: isPrimary ? _gradStart : Colors.amber.shade800,
                              letterSpacing: 0.6,
                            ),
                          ),
                        ),
